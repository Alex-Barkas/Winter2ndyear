...
export default {
    ...
    assignments: [
        ...
        // 10 homework assignments (10% total via Crowdmark), submitted weekly on Mondays at 11:59 PM
        // starting Week 3 (Sept 21). The reading-week Monday (Oct 12) is skipped, so 10 due dates fall
        // between Sept 21 and Nov 30 - matching the "count: 10" in the grading scheme.
        { id: "mthe351-hw1", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 1", date: "2026-09-21", time: "23:59", status: "DONE", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total)." } },
        { id: "mthe351-hw2", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 2", date: "2026-09-28", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw3", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 3", date: "2026-10-05", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw4", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 4", date: "2026-10-19", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). No homework the prior week (reading week). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw5", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 5", date: "2026-10-26", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw6", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 6", date: "2026-11-02", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw7", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 7", date: "2026-11-09", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw8", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 8", date: "2026-11-16", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw9", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 9", date: "2026-11-23", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
        { id: "mthe351-hw10", course: "MTHE 351", category: "ASSIGNMENT", title: "Homework 10", date: "2026-11-30", time: "23:59", status: "PENDING", score: null, details: { type: "text", content: "Weekly homework via Crowdmark. Worth 1% (part of the 10% Homework total). Reminder: work through this with /advisor in Claude Code." } },
