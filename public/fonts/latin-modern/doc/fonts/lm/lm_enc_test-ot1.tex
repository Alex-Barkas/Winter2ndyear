...
\newcommand*{\tekst}{A~q\^u\'{\i}ck br\`ow\~n \TeX\ j\"umps.}
\makeatletter
\newcommand*{\test}[3]{{%
...
\noindent
$\displaystyle
\rho=\left(\sum_{n=0}^\infty2\cdot\frac{n+1}{e^{87i\cdot\phi}n^2}\right]
+7\mathbf{abc}+\mathsf{KC}_3\equiv\Delta\oplus\frac\Xi\lambda$
